...
function runMigrations(db: Database.Database): void {
  ...
  const migrationFiles = ['001_initial.sql', '002_file_providers.sql', '003_api_keys.sql', '004_audit_log.sql', '005_users.sql', '006_provider_wallet.sql', '007_contracts_payments.sql'];
